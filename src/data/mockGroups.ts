...
export interface Group {
    ...
    staffId?: string; // staff assigned to this group for leave requests
}
export interface LeaveRequest {
    id: string;           // r-xxx
    groupId: string;      // nhóm nào
    userId: string;       // người yêu cầu rời
    staffId: string;      // ai sẽ xét duyệt (giả lập staff)
    status: "pending" | "approved" | "rejected";
    createdAt: string;
    groupName: string;    // tên nhóm để hiển thị
}
...
export const staffs: Staff[] = [
    { id: "s-01", name: "Staff A", email: "staff.a@example.com" },
    { id: "s-02", name: "Staff B", email: "staff.b@example.com" }
];
